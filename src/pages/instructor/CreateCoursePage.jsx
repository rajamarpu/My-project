...
import { createCourseRequest, createTaskRequest, uploadContentRequest } from '../../services/api.js'
      ...
      <div className="glass-card p-8 shadow-glow">
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-2">
          <section className="space-y-4 rounded-[2rem] border border-white/10 bg-slate-950/85 p-6 shadow-soft light:border-black/10 light:bg-white/90">
            <p className="text-sm uppercase tracking-[0.25em] text-violet-300 light:text-violet-700">Upload content</p>
          ...
          <section className="space-y-4 rounded-[2rem] border border-white/10 bg-slate-950/85 p-6 shadow-soft light:border-black/10 light:bg-white/90">
            <p className="text-sm uppercase tracking-[0.25em] text-violet-300 light:text-violet-700">Create task</p>
