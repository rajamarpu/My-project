...
export const fetchPreferences = async () => api.get('/portal/preferences')
export const savePreferences = async (payload) => api.put('/portal/preferences', payload)
export const fetchSavedCourses = async () => api.get('/portal/saved-courses')
...
export const fetchPortalNotifications = async (params = {}) => api.get('/portal/notifications', { params })
export const markPortalNotificationRead = async (id) => api.patch(`/portal/notifications/${id}/read`)
export const fetchLiveSessions = async () => api.get('/portal/live-sessions')
export const createLiveSession = async (payload) => api.post('/portal/live-sessions', payload)
export const fetchLearnerReport = async () => api.get('/portal/learner-report')
export const fetchInstructorCourses = async () => api.get('/portal/instructor/courses')
export const fetchCommunityTopics = async () => api.get('/portal/community/topics')
export const createCommunityTopic = async (payload) => api.post('/portal/community/topics', payload)
export const fetchCommunityPosts = async (topicId, params = {}) => api.get(`/portal/community/topics/${topicId}/posts`, { params })
...
export const fetchPlatformSettings = async () => api.get('/portal/admin/settings')
...
export const fetchPaymentHistory = async () => api.get('/portal/payments')
