...
export default function AdminLayout({ children }) {
  ...
  return (
    <div className="admin-shell min-h-screen text-[var(--text-primary)]" style={{ '--admin-sidebar-width': collapsed ? '124px' : '276px' }}>
      <RouteProgress />
      <div className="min-h-screen lg:block">
        ...
        <aside className={`${navOpen ? 'flex animate-upto-fade-slide' : 'hidden'} fixed inset-x-3 top-20 z-40 max-h-[calc(100dvh-6rem)] flex-col overflow-hidden rounded-xl border border-[var(--border-color)] bg-[var(--bg-elevated)] p-3 shadow-soft backdrop-blur-xl transition-[width] duration-200 sm:inset-x-4 sm:p-4 lg:inset-y-0 lg:left-0 lg:top-0 lg:flex lg:h-screen ${collapsed ? 'lg:w-[124px] lg:p-3' : 'lg:w-[276px] lg:p-5'} lg:max-h-none lg:rounded-none lg:border-x-0 lg:border-y-0 lg:border-r lg:shadow-none`}>
